...
if env == 'colab':
    ...
    PREDICTIONS = '/content/Combined-CNN-RNN-for-emotion-recognition/predictions'
    ...
    SAVED_CNN_EXTRACTOR_MODEL = '/content/Combined-CNN-RNN-for-emotion-recognition/data/checkpoints/' \
                                'simple_cnn_ccc_loss.0001-0.7792.hdf5'
    SAVED_RNN_MODEL = '/content/Combined-CNN-RNN-for-emotion-recognition/data/checkpoints/' \
